...
global $row_cols_md_counter, $row_cols_sm_counter, $inner_column_style, $front_background_colors, $previous_blend, $is_cb, $uncode_colors_flat_array, $changer_back_first, $changer_back_color_div, $changer_back_color_row, $changer_back_color_row_inner, $changer_back_color_column_inner;

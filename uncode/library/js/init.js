...
(function(window, undefined) {
	...
	var UNCODE = {
		...
		wwidth: wwidth,
		wheight: wheight,
		webp_lossy_supported: SiteParameters.force_webp ? true : localStorage.getItem('webp_lossy_supported') === 'true' ? true : false,
		webp_lossless_supported: SiteParameters.force_webp ? true : localStorage.getItem('webp_lossless_supported') === 'true' ? true : false,
	};
	// transport
	if (typeof define === 'function' && define.amd) {
		// AMD
